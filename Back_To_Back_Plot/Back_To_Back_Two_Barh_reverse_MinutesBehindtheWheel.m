...
ha1=annotation ("textbox", [0.1 0 0.85 0.99], "string", ...
             {'Average Number of Minutes Drivers'}, ...
...
xlabel('Minutes Behind the Wheel',...
...
TexC=flip({'16-19','20-34','35-49','50-64','65+'});
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
for i=1:length(data)
