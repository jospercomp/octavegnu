...
%%%%%%%%%%%%%%%%%
subplot(1,2,1)
data=[60 54 75 74 66 44 46 56 41 55];
hb= barh(1:length(data),diag(data),"stacked");
xlabel({'Number of Stolen Bases','for a Single Player'},...
...
title("American League",'fontsize',fs);
set(gca(),"xdir","reverse")
box off;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% data arriba de las barras
for i=1:length(data)
ht=text(data(i)+3.5,i-0.14,strcat("",num2str(data(i)),""));
...
%%%%%%%%%%%%%%%%%%
subplot(1,2,2)
data=[39 56 53 60 58 72 62 46 48 45];
hb= barh(1:length(data),diag(data),"stacked");
xlabel({'Number of Stolen Bases','for a Single Player'},...
 'fontsize',fs,'fontweight','bold')
for i=1:length(data)
...
title("National League",'fontsize',fs);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
set(gca,'YTick',1:1:length(data))
set(gca,'XTick',0:10:80)
axis([0 80 0 length(data)+1])
...
% data arriba de las barras
for i=1:length(data)
ht=text(data(i)+3.75,i-0.14,strcat("",num2str(data(i)),""));
set(ht,'fontsize',fs3,'fontweight','bold', ...
'verticalalignment','bottom', ...
'horizontalalignment','center')
endfor
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
for i=1:length(data)
ha1=annotation ("textbox", [0.1 0 0.83 0.87-(i-1)*0.074], "string", ...
             TexC(i), ...
